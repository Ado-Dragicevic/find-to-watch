...
import { Biography, Cast, Credits } from 'src/app/models/credits/credits';
...
export class ShowRelatedResultsService {
  ...
  private extractData(relatedType: ShowRelatedType, results: IndexResponse<Mixed> | Credits | Biography): Cast[] | Mixed[] {
    switch (relatedType) {
      case 'recommendations':
      case 'similar':
